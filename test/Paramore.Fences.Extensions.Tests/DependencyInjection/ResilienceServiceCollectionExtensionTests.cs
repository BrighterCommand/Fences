...
using NSubstitute;
using Paramore.Fences.DependencyInjection;
using Paramore.Fences.Registry;
using Paramore.Fences.Telemetry;

namespace Paramore.Fences.Extensions.Tests.DependencyInjection;

public class ResilienceServiceCollectionExtensionTests
{
    private const string Key = "my-pipeline";
    private ServiceCollection _services;

    public ResilienceServiceCollectionExtensionTests() => _services = [];
