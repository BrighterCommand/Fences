...
public static class TestUtilities
{
    ...
    public static ILoggerFactory CreateLoggerFactory(out FakeLogger logger)
    {
        ...
        loggerFactory.CreateLogger("Paramore.Fences").Returns(logger);

        return loggerFactory;
    }

    public static IDisposable EnableFencesMetering(
        ...
        Predicate<MeteringEvent>? shouldRecord = null)
    {
        ...
        var meterListener = new MeterListener
        {
            ...
            {
                if (instrument.Meter.Name == "Paramore.Fences")
                {
    ...
    /// pipelines with the specified <paramref name="pipelineNames"/>, for use with <see cref="EnableFencesMetering"/>.
    /// </summary>
