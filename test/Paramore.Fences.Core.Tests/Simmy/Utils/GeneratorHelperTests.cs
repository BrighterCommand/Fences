using Paramore.Fences.Simmy.Utils;

namespace Paramore.Fences.Core.Tests.Simmy.Utils;
...
public class GeneratorHelperTests
{
    ...
    public void CreateGenerator_NoGenerators_Ok()
    {
        ...
        helper.CreateGenerator()(ResilienceContextPool.Shared.Get(TestCancellation.Token)).ShouldBeNull();
    }
