...
#pragma warning restore xUnit1031 // Do not use blocking task operations in test method
    ...
    {
        // Before CancellationToken support was built in to Paramore.Fences, users of the library may have implicitly captured a CancellationToken and used it to cancel actions.
        // For backwards compatibility, Paramore.Fences should not confuse these with its own CancellationToken; it should distinguish TaskCanceledExceptions thrown with different CancellationTokens.
        var durationOfBreak = TimeSpan.FromMinutes(1);
        var breaker = Policy
            .Handle<DivideByZeroException>()
            .AdvancedCircuitBreakerAsync(0.5, TimeSpan.FromSeconds(10), 4, durationOfBreak);
