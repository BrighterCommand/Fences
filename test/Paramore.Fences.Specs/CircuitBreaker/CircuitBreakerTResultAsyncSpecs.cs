using Scenario = Paramore.Fences.Specs.Helpers.PolicyTResultExtensionsAsync.ResultAndOrCancellationScenario;
...
#pragma warning restore xUnit1031
    ...
    {
        // Before CancellationToken support was built in to Paramore.Fences, users of the library may have implicitly captured a CancellationToken and used it to cancel actions.  For backwards compatibility, Paramore.Fences should not confuse these with its own CancellationToken; it should distinguish TaskCanceledExceptions thrown with different CancellationTokens.
