...
{
    public static object CreateOpenedCircuitBreaker(FencesVersion version, bool handleOutcome)
    {
    ...
    public static object CreateCircuitBreaker(FencesVersion technology)
    {
