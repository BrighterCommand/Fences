#nullable enable
namespace Paramore.Fences.Utilities;
...
{
    // The TimedLock class throws a LockTimeoutException if a lock cannot be obtained within the LockTimeout.  This allows the easier discovery and debugging of deadlocks during Paramore.Fences development, than if using a pure lock.
