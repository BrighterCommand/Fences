...
public class PolicyResult<TResult>
{
    ...
    {
        var faultType = exceptionType == Paramore.Fences.ExceptionType.HandledByThisPolicy
            ? Paramore.Fences.FaultType.ExceptionHandledByThisPolicy
            : Paramore.Fences.FaultType.UnhandledException;
    ...
    public static PolicyResult<TResult> Failure(TResult handledResult, Context context) =>
        new(default, OutcomeType.Failure, null, null, handledResult, Paramore.Fences.FaultType.ResultHandledByThisPolicy, context);
}
