...
/// <summary>
/// Legacy support for older versions of Paramore.Fences.
/// </summary>
/// <remarks>
/// This class is used by the legacy Paramore.Fences infrastructure and should not be used directly by user code.
/// </remarks>
...
public static class LegacySupport
{
    ...
    /// <remarks>
    /// This method is used by the legacy Paramore.Fences infrastructure and should not be used directly by user code.
    /// </remarks>
    [EditorBrowsable(EditorBrowsableState.Never)]
