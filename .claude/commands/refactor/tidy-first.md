...
- `refactor: rename variables for clarity in RetryResilienceStrategy`
...
- `fix: correct offset acknowledgment in the retry strategy consumer`
...
```text
User: /tidy-first optimize the message processing in RetryResilienceStrategy

[Claude reads RetryResilienceStrategy.cs and analyzes]
...
✓ Committed: refactor: simplify message processing structure in RetryResilienceStrategy
