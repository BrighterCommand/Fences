...
# Triage a bug — restate the symptom, locate the code, form a root-cause hypothesis
...
2. Determine the next bug id and a slug:
   ...
   - Format: `bugfixes/NNNN-{slug}/` (4-digit, e.g. `bugfixes/0001-retry-fires-on-cancelled-outcome/`)
...
2. If on `main`, offer to create a fix branch:
