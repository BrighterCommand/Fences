...
END {
    ...
    print "[`.agent_instructions/adr_frontmatter.md`](https://github.com/BrighterCommand/Fences/blob/main/.agent_instructions/adr_frontmatter.md)."
    print ""
    print "Identity is the `id` (filename stem), not the leading number — numbers may repeat if two branches allocate concurrently."
    print ""
